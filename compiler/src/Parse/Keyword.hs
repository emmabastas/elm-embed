...
subscription_ toError =
  P.Parser $ \(P.State src pos end indent row col start) cok _ _ eerr ->
    ...
    then
      let !s = P.State src pos12 end indent row (col + 12) start in cok () s
    else
...
k2 w1 w2 toError =
  P.Parser $ \(P.State src pos end indent row col start) cok _ _ eerr ->
    ...
    then
      let !s = P.State src pos2 end indent row (col + 2) start in cok () s
    else
      eerr row col toError
...
k3 w1 w2 w3 toError =
  P.Parser $ \(P.State src pos end indent row col start) cok _ _ eerr ->
    ...
    then
      let !s = P.State src pos3 end indent row (col + 3) start in cok () s
    else
      eerr row col toError
...
k4 w1 w2 w3 w4 toError =
  P.Parser $ \(P.State src pos end indent row col start) cok _ _ eerr ->
    ...
    then
      let !s = P.State src pos4 end indent row (col + 4) start in cok () s
    else
      eerr row col toError
...
k5 w1 w2 w3 w4 w5 toError =
  P.Parser $ \(P.State src pos end indent row col start) cok _ _ eerr ->
    ...
    then
      let !s = P.State src pos5 end indent row (col + 5) start in cok () s
    else
      eerr row col toError
...
k6 w1 w2 w3 w4 w5 w6 toError =
  P.Parser $ \(P.State src pos end indent row col start) cok _ _ eerr ->
    ...
    then
      let !s = P.State src pos6 end indent row (col + 6) start in cok () s
    else
      eerr row col toError
...
k7 w1 w2 w3 w4 w5 w6 w7 toError =
  P.Parser $ \(P.State src pos end indent row col start) cok _ _ eerr ->
    ...
    then
      let !s = P.State src pos7 end indent row (col + 7) start in cok () s
    else
      eerr row col toError
...
k8 w1 w2 w3 w4 w5 w6 w7 w8 toError =
  P.Parser $ \(P.State src pos end indent row col start) cok _ _ eerr ->
    ...
    then
      let !s = P.State src pos8 end indent row (col + 8) start in cok () s
    else
      eerr row col toError
